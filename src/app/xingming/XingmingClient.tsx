...
'徐':10,'孙':6,'马':3,'胡':9,'朱':6,'郭':10,'何':7,'高':10,'林':8,'罗':8,
'郑':8,'梁':11,'谢':12,'宋':7,'唐':10,'韩':12,'曹':11,'许':6,'邓':9,
'冯':5,'萧':11,'程':12,'蔡':14,'彭':12,'潘':15,'袁':10,'董':12,'田':5,'丁':2,
'方':4,'石':5,'沈':7,'苏':7,'卢':5,'蒋':12,'魏':17,'贾':10,'范':8,'金':8,
'孟':8,'秦':10,'顾':10,'乔':6,'白':5,'毛':4,'江':6,'谭':14,'廖':14,'崔':11,
'邹':7,'熊':14,'任':6,'康':11,'郝':9,'叶':5,'陆':7,'段':9,'侯':9,'黎':15,
'文':4,'武':8,'曾':12,'关':6,'夏':10,'严':7,'殷':10,'常':11,'卫':3,'史':5,
'于':3,'苗':8,'姚':9,'姜':9,'薛':16,'邱':7,'汪':7,'倪':10,'汤':6,
'大':3,'小':3,'中':4,'国':8,'人':2,'民':5,'和':8,'生':5,'年':6,'月':4,
'日':4,'时':7,'上':3,'下':3,'永':5,'安':6,'平':5,'吉':6,'祥':10,'瑞':13,
'福':13,'禄':12,'寿':7,'喜':12,'财':7,'富':12,'贵':9,'荣':9,'华':6,'昌':8,
'盛':11,'兴':6,'隆':11,'伟':6,'杰':8,'军':9,'强':12,'刚':10,'勇':9,'毅':15,
'志':7,'诚':8,'信':9,'忠':8,'孝':7,'仁':4,'义':3,'礼':5,'智':12,'明':8,
'亮':9,'清':11,'洁':9,'丽':7,'美':9,'俊':9,'豪':14,'龙':5,'凤':4,'鹏':13,
'鹤':15,'飞':3,'天':4,'地':6,'宇':6,'洪':9,'博':12,'贤':15,'良':7,'德':15,
'道':12,'光':6,'辉':12,'海':10,'洋':9,'东':5,'南':9,'西':6,'北':5,'春':9,
'夏':10,'秋':9,'冬':5,'山':3,'川':3,'云':4,'雪':11,'梅':11,'兰':5,'竹':6,
'菊':11,'松':8,'柏':9,'枫':8,'柳':9,'花':7,'玉':5,'宝':8,'莲':10,'琴':12,
'琪':13,'琳':13,'慧':15,'敏':11,'婷':12,'娟':10,'欣':8,'悦':10,'嘉':14,'宁':5,
'静':14,'怡':8,'彤':7,'鑫':24,'森':12,'磊':15,'晶':12,'锋':12,'锦':16,'铭':14,
'泽':8,'浩':10,'宸':10,'哲':10,'航':10,'奕':9,'凯':8,'逸':11,'皓':12,'钧':9,
'霆':15,'霖':16,'翰':16,'修':9,'旭':6,'睿':14,'奇':8,'钰':10,'玥':8,'柠':9,
'汐':6,'洛':9,'涵':11,'泓':8,'淇':11,'淳':11,'萱':12,'燕':16,'莹':10,'薇':16,
'昊':8,'昕':8,'昀':8,'晟':11,'晖':13,'晏':10,'晴':12,'曜':18,'朗':10,'峰':10,
'峻':10,'岚':7,'源':13,'润':10,'泽':8,'泰':10,'丰':18,'盈':9,'茂':11,'庆':6,
'贺':9,'颂':13,'祝':10,'佑':7,'祯':13,'祺':13,
}
...
export default function XingmingClient() {
  ...
  return (<div className="max-w-3xl mx-auto px-4 py-10">
    <h1 className="text-3xl font-bold text-gold-400 font-serif mb-3">姓名测试打分</h1>
    <p className="text-gray-400 mb-6">基于五格数理和三才五行配置进行姓名分析评分</p>
