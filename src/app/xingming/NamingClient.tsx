...
const WXC: Record<string, string> = {
  '木':'bg-gold-500/10 text-gold-600 border-gold-500/25',
  '火':'bg-gold-500/10 text-gold-600 border-gold-500/25',
  '土':'bg-gold-500/10 text-gold-600 border-gold-500/25',
  '金':'bg-gold-500/10 text-gold-600 border-gold-500/25',
  '水':'bg-gold-500/10 text-gold-600 border-gold-500/25',
}
      ...
      {tab === 'wuxing' ? (
        <>
          ...
          <div className="bg-dark-800/80 rounded-xl border border-dark-600 p-6">
            ...
            {wxError && <p className="text-xs text-gold-600 mt-2">{wxError}</p>}
          </div>
          ...
          {baziResult && (() => {
            ...
            const wxColor: Record<string,string> = {'木':'from-gold-500 to-gold-600','火':'from-gold-500 to-gold-600','土':'from-gold-500 to-gold-600','金':'from-gold-500 to-gold-600','水':'from-gold-500 to-gold-600'}
            const wxBg: Record<string,string> = {'木':'bg-gold-500/30','火':'bg-gold-500/30','土':'bg-gold-500/30','金':'bg-gold-500/30','水':'bg-gold-500/30'}
            return (
              <div className="bg-dark-800/80 rounded-xl border border-dark-600 p-5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-xs">
                  ...
                  <div className="bg-dark-700 rounded-lg p-3">
                    ...
                    <span className={`text-sm font-semibold ${b.bodyStrength==='身强'?'text-gold-600':b.bodyStrength==='身弱'?'text-gold-600':'text-gold-500'}`}>{b.bodyStrength}</span>
                  </div>
                  <div className="bg-dark-700 rounded-lg p-3">
                ...
                {wxResults.map((r, i) => (
                  <div key={i} className="bg-dark-800/80 rounded-xl border border-gold-500/20 p-5 hover:border-gold-500/50 transition-all">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className={`text-lg font-bold ${r.avgScore>=80?'text-gold-600':r.avgScore>=60?'text-gold-500':'text-gold-600'}`}>{r.avgScore}分</span>
                    </div>
