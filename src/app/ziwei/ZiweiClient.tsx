        ...
        <div ref={exportRef} className="space-y-6">
          ...
          <h2 className="text-lg font-semibold text-gold-400 font-serif">
            ...
            <span className="text-xs text-gray-500 font-normal ml-3">
              {getT('ziweiPage.goodFortune')}:<span className={`font-bold ${fortuneScore >= 80 ? 'text-green-400' : fortuneScore >= 60 ? 'text-yellow-400' : fortuneScore >= 40 ? 'text-orange-400' : 'text-red-400'}`}>{fortuneScore}</span>
            </span>
          </h2>
          ...
          <div className="bg-dark-800/80 rounded-xl border border-gold-500/20 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <table className="w-full text-xs"><tbody>
                  <tr className="border-b border-dark-600"><td className="py-1.5 text-green-400 font-medium">{getT('ziweiPage.auspiciousStars')}</td><td className="py-1.5 text-red-400 font-medium">{getT('ziweiPage.inauspiciousStars')}</td></tr>
                  ...
                  <tr>
                    <td className="py-1.5 text-green-400 font-semibold">{getT('ziweiPage.auspiciousCount').replace('{n}', String(auspCount))}</td>
                    <td className="py-1.5 text-red-400 font-semibold">{getT('ziweiPage.inauspiciousCount').replace('{n}', String(inauspCount))}</td>
                  </tr>
                </tbody></table>
                ...
                <p className="text-xs text-gray-400 mt-1">{getT('ziweiPage.goodFortune')}=<span className={`font-bold ${fortuneScore >= 80 ? 'text-green-400' : fortuneScore >= 60 ? 'text-yellow-400' : fortuneScore >= 40 ? 'text-orange-400' : 'text-red-400'}`}>{fortuneScore}</span></p>
              </div>
            </div>
          </div>
