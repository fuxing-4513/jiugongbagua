...
export const metadata: Metadata = {
  title: '塔罗牌在线占卜',
  description: '免费在线塔罗牌占卜，韦特塔罗78张完整牌库。三牌牌阵、凯尔特十字、关系牌阵、事业牌阵、日运单牌多牌阵选择，3D翻牌动画，多维度深度解读。',
  keywords: '塔罗,塔罗牌,塔罗占卜在线,韦特塔罗,三牌牌阵,凯尔特十字,塔罗解读,塔罗牌义大全,塔罗牌在线免费,关系牌阵,事业牌阵,日运塔罗',
  openGraph: { title: '塔罗牌在线占卜', description: '免费在线塔罗牌占卜 — 三牌牌阵·凯尔特十字·关系·事业·日运，3D翻牌动画' },
