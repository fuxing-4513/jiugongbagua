...
const baseDescription = '九宫八卦是中国传统命理文化平台，提供八字算命、紫微斗数、六爻、小六壬、周公解梦、姓名测试、号码测吉凶、黄历择日、塔罗、测字等在线服务。'
...
export const metadata: Metadata = {
  ...
  keywords: ['九宫八卦','八字算命','紫微斗数','六爻','小六壬','周公解梦','姓名测试','号码测吉凶','黄历','塔罗','测字','命理','易经','梅花易数','合婚','传统文化','奇门遁甲'],
  authors: [{ name: '九宫八卦' }],
  creator: '九宫八卦',
  publisher: '九宫八卦',
  openGraph: {
