...
const modules: ModuleInfo[] = [
  ...
  { key: 'chenggu', nameKey: 'modules.chenggu.name', descKey: 'modules.chenggu.desc', emoji: '??', href: '/fengshui' },
  { key: 'shengxiao', nameKey: 'modules.shengxiao.name', descKey: 'modules.shengxiao.desc', emoji: '??', href: '/fengshui' },
  { key: 'xingzuo', nameKey: 'modules.xingzuo.name', descKey: 'modules.xingzuo.desc', emoji: '?', href: '/fengshui' },
  { key: 'qimen', nameKey: 'modules.qimen.name', descKey: 'modules.qimen.desc', emoji: '??', href: '/fengshui' },
  { key: 'meihua', nameKey: 'modules.meihua.name', descKey: 'modules.meihua.desc', emoji: '??', href: '/fengshui' },
  { key: 'lingqian', nameKey: 'modules.lingqian.name', descKey: 'modules.lingqian.desc', emoji: '??', href: '/fengshui' },
