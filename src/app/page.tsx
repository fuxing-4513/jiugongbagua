...
const modules: ModuleInfo[] = [
  ...
  { key: 'fengshui', nameKey: 'modules.fengshui.name', descKey: 'modules.fengshui.desc', emoji: '🧭', href: '#' },
  { key: 'chenggu', nameKey: 'modules.chenggu.name', descKey: 'modules.chenggu.desc', emoji: '⚖️', href: '#' },
  { key: 'shengxiao', nameKey: 'modules.shengxiao.name', descKey: 'modules.shengxiao.desc', emoji: '🐉', href: '#' },
  { key: 'xingzuo', nameKey: 'modules.xingzuo.name', descKey: 'modules.xingzuo.desc', emoji: '♈', href: '#' },
  { key: 'qimen', nameKey: 'modules.qimen.name', descKey: 'modules.qimen.desc', emoji: '🌀', href: '#' },
  { key: 'meihua', nameKey: 'modules.meihua.name', descKey: 'modules.meihua.desc', emoji: '🌸', href: '#' },
  { key: 'lingqian', nameKey: 'modules.lingqian.name', descKey: 'modules.lingqian.desc', emoji: '🏮', href: '#' },
