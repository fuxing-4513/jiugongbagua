...
interface Dream { keyword: string; title: string; meaning: string; category: string }
...
const DREAMS: Dream[] = [
  ...
  { keyword: '冰', title: '冰', category: '自然', meaning: '梦见冰象征冻结的情感或僵局。滑冰主轻松应对，冰裂示危机，冰雪消融示关系回暖。' },
  ...
  { keyword: '头', title: '头', category: '身体', meaning: '梦见头代表理智与思考。头痛示压力大，头大示聪明，头发脱落示烦恼。' },
  { keyword: '脖子', title: '脖子', category: '身体', meaning: '梦见脖子代表连接与承受。脖子痛示负重，勒颈示受束缚，项链示美好连接。' },
  { keyword: '肩膀', title: '肩膀', category: '身体', meaning: '梦见肩膀代表责任与承担。宽肩示能担当，肩痛示负担过重，拍肩示鼓励。' },
  { keyword: '腿', title: '腿', category: '身体', meaning: '梦见腿代表支撑与前进。腿有力示根基稳，腿伤示前进受阻，跑步示追求目标。' },
  { keyword: '皮肤', title: '皮肤', category: '身体', meaning: '梦见皮肤代表边界与保护。皮肤光滑示自信，皮肤溃烂示内心不安，纹身示个性表达。' },
  { keyword: '手指', title: '手指', category: '身体', meaning: '梦见手指代表细节与操作。手指灵活主手巧，手指伤示细节失误，数指示精打细算。' },
  { keyword: '指甲', title: '指甲', category: '身体', meaning: '梦见指甲代表防卫与细节。长指甲示防备，断甲示防卫失效，美甲示注重外表。' },
  { keyword: '舌头', title: '舌头', category: '身体', meaning: '梦见舌头代表表达与品味。舌灿莲花主口才好，舌伤示表达受阻，尝味示品味人生。' },
  { keyword: '耳朵', title: '耳朵', category: '身体', meaning: '梦见耳朵代表倾听与接收。耳聪主善听，耳鸣示有闲言碎语，耳环示装饰。' },
  { keyword: '后背', title: '后背', category: '身体', meaning: '梦见后背代表支撑与隐藏。背痛示负担重，背后有人示需要提防，驼背示压力。' },
  ...
  { keyword: '伞', title: '伞', category: '物品', meaning: '梦见伞代表保护与遮蔽。撑伞主有人庇护，伞破示保护不足，丢伞示失去依靠。' },
  { keyword: '钟', title: '钟', category: '物品', meaning: '梦见钟代表时间与提醒。钟声示重要时刻，钟表停走示时间停滞，闹钟示警示。' },
  { keyword: '电话', title: '电话', category: '物品', meaning: '梦见电话代表沟通与消息。接电话主有消息来，打不通示沟通障碍，电话线断示失联。' },
  { keyword: '门', title: '门', category: '物品', meaning: '梦见门代表机会与入口。开门主机会来临，关门示机会错失，打不开门示阻碍。' },
  { keyword: '窗户', title: '窗户', category: '物品', meaning: '梦见窗户代表视野与出口。开窗示心胸开阔，窗破示有突破，关窗示封闭。' },
  { keyword: '楼梯', title: '楼梯', category: '物品', meaning: '梦见楼梯代表晋升与进步。上楼梯主步步高升，下楼梯示退步，楼梯断示中断。' },
  ...
  { keyword: '跳楼', title: '跳楼', category: '场景', meaning: '梦见跳楼代表极端的逃避或解脱愿望。跳下示想摆脱困境，犹豫示内心挣扎，被救示转机。' },
  { keyword: '坐飞机', title: '坐飞机', category: '场景', meaning: '梦见坐飞机代表追求高度与速度。平稳飞行主事业顺利，飞机颠簸示波折，延误示耐心。' },
  { keyword: '走夜路', title: '走夜路', category: '场景', meaning: '梦见走夜路代表面对未知的勇气。平安走过示胆识过人，遇险示恐惧，有灯示有指引。' },
  { keyword: '上学', title: '上学', category: '场景', meaning: '梦见上学代表学习与成长。回到学校示怀旧，上课走神示注意力分散，毕业示圆满。' },
  ...
  { keyword: '朋友', title: '朋友', category: '人物', meaning: '梦见朋友代表社交与支持。朋友相聚主人际关系好，朋友反目示信任危机，新朋友示新机遇。' },
  { keyword: '爱人', title: '爱人', category: '人物', meaning: '梦见爱人代表情感与亲密。爱人温柔主感情甜蜜，吵架示需要沟通，分手示不安。' },
  { keyword: '前任', title: '前任', category: '人物', meaning: '梦见前任代表未处理的情感。和平相处示已放下，纠缠不清示心结未解，复合示怀旧。' },
  { keyword: '敌人', title: '敌人', category: '人物', meaning: '梦见敌人代表冲突与对抗。战胜敌人主克服困难，被敌人打败示需要反省。' },
  { keyword: '死人', title: '死人', category: '人物', meaning: '梦见死人通常是对逝者的思念或未了之事。与死人说话示有话未说，死人复活示转机。' },
  ...
  { keyword: '死人复活', title: '死人复活', category: '特殊', meaning: '梦见死人复活代表转机与希望。已故亲人复活示好事将近，陌生人复活示意想不到的变化。' },
  { keyword: '鬼', title: '鬼', category: '特殊', meaning: '梦见鬼代表恐惧与未解心结。见鬼示内心不安，被鬼追示逃避问题，驱鬼示战胜恐惧。' },
  { keyword: '上厕所', title: '上厕所', category: '特殊', meaning: '梦见上厕所代表释放与清理。顺利如厕示压力释放，找不到厕所示憋屈，肮脏厕所示烦恼。' },
  { keyword: '搬家', title: '搬家', category: '特殊', meaning: '梦见搬家代表生活环境或心态的转变。顺利搬家主新开始，搬家中断示犹豫，新家大吉。' },
  ...
  { keyword: '嫉妒', title: '嫉妒', category: '情感', meaning: '梦见嫉妒代表不安全感。嫉妒他人示不满现状，被嫉妒示有令人羡慕之处。' },
  { keyword: '无奈', title: '无奈', category: '情感', meaning: '梦见无奈代表无能为力之感。无奈叹息示需要调整期待，接受现实示成熟。' },
  ...
  { keyword: '鸡蛋', title: '鸡蛋', category: '食物', meaning: '梦见鸡蛋代表新生与潜力。完整鸡蛋示机会待发掘，破蛋示突破，孵蛋示耐心等待。' },
  { keyword: '牛奶', title: '牛奶', category: '食物', meaning: '梦见牛奶代表滋养与纯洁。喝牛奶主身体健康，牛奶溢出示浪费，酸牛奶示变质。' },
]

// ── 热门关键词 ──
const HOT_KEYWORDS = [
  '蛇','狗','猫','鱼','牙齿','头发','水','火','雨','飞翔','坠落','考试','死亡',
  '钱','血','小孩','怀孕','结婚','哭','追','逃跑','红色','白色','黑色','金色'
]
...
export default function JiemengClient() {
  ...
  const doSearch = (q: string) => {
    ...
    // 多词匹配：空格分隔，每个词必须至少匹配一条字段
    const terms = trimmed.split(/\s+/).filter(Boolean)
    const matched = DREAMS.filter(d => {
      const haystack = `${d.keyword} ${d.title} ${d.meaning}`
      // 模糊匹配：输入词包含关键词 或 关键词包含输入词 或 含义包含词
      return terms.every(term =>
        d.keyword.includes(term) || term.includes(d.keyword) ||
        d.title.includes(term) || term.includes(d.title) ||
        d.meaning.includes(term) || haystack.includes(term)
      )
    })
    setResults(matched)
    setSearched(true)
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="bg-dark-800/80 backdrop-blur rounded-xl border border-dark-600 p-6 mb-6">
        ...
        <p className="text-[10px] text-gray-600 mt-2">收录 {totalDreams} 条梦境解析 · 支持多词搜索（如"梦见蛇咬"）</p>
      </div>
      ...
      {searched && results.length === 0 && (
        <div className="bg-dark-800/80 backdrop-blur rounded-xl border border-dark-600 p-5">
          ...
          <p className="text-xs text-gray-500 mb-2">试试以下推荐关键词：</p>
          <div className="space-y-3">
      ...
      {!searched && (
        <div className="bg-dark-800/80 backdrop-blur rounded-xl border border-dark-600 p-5 text-center">
          <p className="text-lg text-gray-500 mb-2">🌙 输入梦境关键词开始解梦</p>
          <p className="text-sm text-gray-600">支持单字或短语搜索，如 蛇、掉牙、梦见水</p>
        </div>
      )}
    </div>
  )
