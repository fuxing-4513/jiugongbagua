...
const LIBS = [
  { id: 'dunhuang', name: '敦煌玄学文献著录库', emoji: '🏜️', desc: '法国 BnF Pelliot 与英国 BL Stein 敦煌遗书中的风水、占梦、星占、择日、道经文献——P/S 编号体系著录', count: DUNHUANG_CATALOG.length, items: DUNHUANG_CATALOG },
