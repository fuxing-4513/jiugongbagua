...
const SECTIONS = [
  ...
  },
  {
    ...
    tag: '建设中',
    tagColor: 'text-amber-600 dark:text-amber-300 bg-amber-500/10',
  },
  {
    href: '/glossary',
    emoji: '📖',
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <div className="rounded-2xl border border-dashed border-gray-300/70 dark:border-gray-600/50 p-8 text-center">
        ...
        <h2 className="font-bold text-gray-700 dark:text-gray-200 mb-2">原创文章区</h2>
        <p className="text-sm text-gray-400 max-w-md mx-auto leading-relaxed">
          九宫文库的原创文章正在规划中——每一篇都将基于完整的命理推理逻辑，
          有深度、有观点、有可读性。
        </p>
      </div>
    </div>
