  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed right-0 top-1/2 -translate-y-1/2 z-40 flex flex-col items-center gap-1 px-2 py-3 rounded-l-lg bg-gold-500/85 text-white text-[10px] font-medium shadow-lg hover:bg-gold-500/50 hover:shadow-gold-500/30 transition-all duration-200 cursor-pointer"
        title="专家解析"
      >
