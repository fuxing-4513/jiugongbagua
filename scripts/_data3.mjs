// Key data generation for building XingzuoClient.tsx
// This writes separate data files that the main generator will read.

import { writeFileSync } from 'fs';

// === DATA FILES ===

// 1. Constellation data (3 missing signs: 摩羯, 水瓶, 双鱼)
const DATA_MISSING = `const _data3 = ${JSON.stringify({
  '摩羯座': {
  ...
  '双鱼座': {
    ...
    conclusion: '双鱼座教会我们慈悲与想象的珍贵。你是宇宙之梦的编织者，用柔软的内心感受着世间的一切。你的善良与灵性是这个世界最纯净的光。记录：真正的强大不是坚硬，而是在看透世界的残酷之后依然选择温柔相待。愿你永远保持对美的感知，用你的爱让这个世界更加柔软。',
  },
})};\n`;

writeFileSync('scripts/_data3.mjs', DATA_MISSING, 'utf8');
console.log('Written _data3.mjs');
